    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('org_admin', 'Organization Admin'), ('treasurer', 'Treasurer'), ('auditor', 'Auditor'), ('committee', 'Committee Member'), ('standard', 'Standard Member')], default='standard', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('attachment', models.FileField(blank=True, null=True, upload_to='meetings/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
