"""
Django settings for fund_platform project.
...
SECRET_KEY = 'django-insecure-*%9$cw5yyuyu)h_-e1-v2i)53^bq*3avl$(#$u8k^6z$)2ik7s'
...
ROOT_URLCONF = 'fund_platform.urls'
...
WSGI_APPLICATION = 'fund_platform.wsgi.application'
